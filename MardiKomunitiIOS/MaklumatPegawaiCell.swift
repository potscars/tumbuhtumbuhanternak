...
class MaklumatPegawaiCell: UICollectionViewCell {
    ...
    lazy var tableview: UITableView = {
        ...
        tableView.register(PetaniInfoTableViewCell.self, forCellReuseIdentifier: ProjekIdentifier.PegawaiTableViewCell)
